Rails.application.routes.draw do
  ...
  resources :evaluations do
    resources :grade_evaluations, only: [:show, :new, :create, :edit, :update, :index]
  end
  
  resources :practices do
    resources :grade_practices, only: [:show, :new, :create, :edit, :update, :index]
  end
